...
export default function HomePage() {
  ...
  const pointsCards = [
    { pts: '+5', label: 'نتيجة كاملة', icon: '🎯', desc: 'توقعت النتيجة النهائية بدقة.' },
    ...
    { pts: '+3', label: 'كارت أحمر', icon: '🟥', desc: 'توقعت وجود بطاقة حمراء.' },
  ...
  const prizes = [
    ...
    },
    {
      phase: 'دور الـ 32',
      date: '3 يوليو 2026',
      desc: 'أعلى نقاط في هذه المرحلة يحصل على الجائزة وعند التساوي تُقسم الجائزة.',
      reward: '5,000 جنيه',
      icon: '🏅',
    },
    {
