...
// على آخر 20 ماتش محسوم في البطولة. نفس معادلة السقف في الداشبورد:
...
const WINDOW = 20;      // آخر كام ماتش محسوم
const TOP = 25;         // كام متسابق نطلّع
const MIN_PREDS = 5;    // أقل عدد توقعات داخل النافذة عشان العضو يظهر (عدالة)
...
export async function GET() {
  try {
    // 1) آخر 20 ماتش محسوم (نتيجة مسجّلة) بترتيب زمني تنازلي
